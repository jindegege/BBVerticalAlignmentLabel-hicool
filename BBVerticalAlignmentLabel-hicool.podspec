#
#  Be sure to run `pod spec lint BBVerticalAlignmentLabel-hicool.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/jindegege/BBVerticalAlignmentLabel-hicool.git", :tag => s.version }
